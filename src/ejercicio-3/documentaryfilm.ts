 ...
 */
export class DocumentaryFilm extends BasicStreamableCollection<documentary> {
  /**
   * Crea una nueva instancia de una colección
   * @param Emissions Colección de Documentales
   */
  constructor(protected Emission: documentary[]) {
    super(Emission);
  }

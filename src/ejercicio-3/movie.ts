...
/**
 * Atributos que tiene una movie
 * @param title Título de la movie
 * @param year Año en que fue lanzado
 * @param genero genero de la movie
 */
export type movie = {
  title: string;
  year: number;
 ...
 */
export class Movie extends BasicStreamableCollection<movie> {
  /**
   * Crea una nueva instancia de una colección
   * @param Emissions Colección de series
   */
  constructor(protected Emission: movie[]) {
    super(Emission);
  }
